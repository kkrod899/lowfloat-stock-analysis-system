...
try:
    # --- データ取得 ---
    url = "https://finviz.com/screener.ashx?v=152&o=-change&c=0,1,2,6,8,9,65" # Ticker,Company,Sector,Price,Change,Volume,Float
    ...
    if not df_watch.empty:
        ...
        # 通知メッセージの日付を明記
        market_date = (dt.datetime.utcnow() - dt.timedelta(hours=4)).date() # 米国市場の日付
